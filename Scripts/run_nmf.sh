...
out_dir="../example_results_new/" # output directory
py_script="${script_dir}/run_nmf.py"

expr_f="${data_dir}${data_file}"
krange="[11,20]" # K (rank) for running NMF. ex. "[5]": NMF will be performed for K=5; "[3,5]": NMF will be performed for K=3, K=4, and K=5; "[3,5,6,8]": NMF will be performed for K=3, K=5, K=6 and K=8. 
